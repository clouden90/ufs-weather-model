...
#default resources
export TASKS=$TASKS_datm_dflt
export TPN=$TPN_datm_dflt

export med_petlist_bounds=$MPB_datm_dflt
export atm_petlist_bounds=$APB_datm_dflt
export ocn_petlist_bounds=$OPB_datm_dflt
export ice_petlist_bounds=$IPB_datm_dflt
...
# DATM defaults
export INPUT_NML="input.mom6_datm.nml.IN"
